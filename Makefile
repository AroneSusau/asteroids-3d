...
BASE_OBJECTS = Asteroid.o Axis.o Bullet.o Cannon.o Camera.o EulerRotation.o Lighting.o main.o Mouse.o RigidBody.o Ship.o Skybox.o Time.o Util.o Wall.o World.o
